...
export const DailyCalendar = () => {
  ...
  // TODO: render separator lines afte each hour label
  return (
    <div className="grid grid-cols-12 p-4 w-full" style={{ height: total_height }}>
          ...
          return (
            <Popover key={i}>
              ...
              >
                ...
                <Separator orientation="horizontal" className="bg-red-300 z-0 w-full absolute" />
              </PopoverTrigger>
              <PopoverContent>
      ...
      <div
        className="col-start-3 col-span-9 row-start-1 relative z-10"
        style={{ height: total_height }}
      >
